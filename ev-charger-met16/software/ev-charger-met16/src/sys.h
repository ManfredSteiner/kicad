...
#define SYS_LCD_SET_RS   PORTB |=  (1 << PB5); // Signal RS=1
#define SYS_LCD_CLR_RS   PORTB &= ~(1 << PB5); // Signal RS=0
#define SYS_LCD_SET_RW   PORTB |=  (1 << PB4); // Signal RW=1
#define SYS_LCD_CLR_RW   PORTB &= ~(1 << PB4); // Signal RW=0
#define SYS_LCD_SET_E    PORTD |=  (1 << PD7); // Signal E=1 
#define SYS_LCD_CLR_E    PORTD &= ~(1 << PD7); // Signal E=0 
